...
public class InlineKeyboardMarkupSource {
    ...
    protected List<InlineKeyboardButton> getContinueInlineButton() {
        List<InlineKeyboardButton> buttons = new ArrayList<>();

        InlineKeyboardButton button = new InlineKeyboardButton();
        button.setText(EmojiParser.parseToUnicode(CONTINUE_EMOJI + " Продолжить " + CONTINUE_EMOJI));
        button.setCallbackData("callback.continue");
        buttons.add(button);
